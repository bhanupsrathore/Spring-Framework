...
public class HelloController {
	...
	//http://localhost:8055/SpringWebMVC/mvcweb/hello/requestParam?username=Jack&age=22
	...
	//PathVariable
	//http://localhost:8055/SpringWebMVC/mvcweb/hello/pathvar/Jack/22
	
	//http://localhost:8055/SpringWebMVC/mvcweb/employee?id=1
	//http://localhost:8055/SpringWebMVC/mvcweb/employee/1
